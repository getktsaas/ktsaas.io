...
import screenshotCiCd from '@/images/screenshots/ci-cd.png'
import screenshotDeploy from '@/images/screenshots/docker-services.png'
import screenshotPortainer from '@/images/screenshots/portainer-mysql.png'

const features = [
  {
    name: 'CI/CD',
    summary: 'Already configured with CI, green builds & one-click deploys on every PR.',
    description:
  ...
  },
  {
    name: 'Deploy',
    summary:
      'Docker Swarm deploys with HTTPS, routing, & login flow built in.',
    description:
